...
from shared.vectorizer import build_vector_assets
...
app = FastAPI(title="table_gen mac step-segment", version="1.0.0")
...
def run_segment(payload: SegmentRequest) -> SegmentResponse:
    session_dir = DATA_ROOT / "sessions" / payload.session_id / "segment"
